...
for csv in csvs:
	numcsv = numcsv+1
	df, fs, ls = input.load_csv(os.path.join('ml2-master2/data/fa15/op+context-count+type+size', csv), filter_no_labels=True, only_slice=False)
